...
public class DotsAndBoxes {
    public static void main(String[] args)
    {
        ...
        System.out.println("Made by Zornitsa Dimitrova, Plamena Gospodinova and Atanas Peshev");
        int width = 0;
        int height = 0;
        int numPlys = 0;
        ...
        while(numPlys == 0)
        {
            ...
            {
                System.out.print("\nThat is not a valid number of plys. Try again.");
            }
        }
        while(playerSelection == 0)
        {
            System.out.println("\nDecide who you want to go first:");
